...
export default function SbcListRecord({ frontMatter, layout = 'card' }) {
  const { slug, title: originalTitle, imageUrl, summary, includeAsSBC } = frontMatter
  ...
  if (layout === 'card') {
    return (
      <article className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600">
        ...
        <Link
          href={`/${slug}`}
          className="relative w-full aspect-[16/9] overflow-hidden bg-gray-100 dark:bg-gray-800 block"
        >
                ...
                {Object.entries(specifications)
                  ...
                  .map(([key, value]) => {
                              ...
                              return (
                                <div key={subKey} className="flex items-start">
                                  {hasUrl ? (
                                    ...
                                    <>
                                      <span className="font-bold text-gray-600 dark:text-gray-400 mr-2">
                                        {subKey}:
                                      </span>
                                      <span className="text-gray-600 dark:text-gray-400">
                    ...
                    return (
                      <div
                        key={key}
                        className="flex items-start py-1 px-2 bg-gray-50 dark:bg-gray-700/50 rounded"
                      >
    ...
    <article className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600">
      <div className="grid grid-cols-12 gap-6 items-start p-6">
        ...
        <div className="col-span-4 flex flex-col items-center space-y-4">
          ...
          <Link
            href={`/${slug}`}
            className="relative overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800 w-full aspect-[16/9] block"
          >
                  ...
                  .map(([key, value]) => {
                    ...
                    if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
                      return (
                        <div
                          key={key}
                          className="py-1.5 px-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg"
                        >
                          <span className="font-bold text-gray-700 dark:text-gray-300">{key}:</span>
                    ...
                    return (
                      <div
                        key={key}
                        className="flex items-start py-1.5 px-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg"
                      >
                        <span className="font-bold text-gray-700 dark:text-gray-300 mr-2">
                          {key}:
                        </span>
